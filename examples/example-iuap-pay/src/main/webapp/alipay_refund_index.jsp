...
<body>
    <div class="header">
        <div class="container">
            <div class="nav">
                <a href="https://www.alipay.com/" class="logo"><img src="resources/images/alipay_logo.png" height="30px"></a>
    ...
    <div class="content">
        <form action="refund/bill" class="alipayform" method="POST" target="_blank">
        	<input type=hidden name="refund_type" value="ALI"/>
            <div class="element" style="margin-top:60px;">
                <div class="legend">支付宝即时到账批量退款有密接口快速通道 </div>
            </div>
            <div class="element">
                <div class="etitle">退款批次号:</div>
                <div class="einput"><input type="text" name="batch_no" id="batch_no"></div>
                <br>
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="batch_num" ></div>
                <br>
                <div class="mark">注意：退款笔数(batch_num)，必填(值为您退款的笔数,取值1~1000间的整数)</div>
            </div>
            <div class="element">
                <div class="etitle">退款详细数据:</div>
                <div class="einput"><input type="text" name="detail_data"></div>
                <br>
                <div class="mark">注意：退款详细数据(detail_data)，必填(支付宝交易号^退款金额^备注)多笔请用#隔开</div>
            </div>
            <div class="element">
                <div class="etitle">异步回调地址:</div>
                <div class="einput"><input type="text" name="notify_url" value="http://iuap.yonyou.com/notify_url.jsp"></div>
                <br>
            </div>
            <div class="element">
