function init(){
    ...
    var namenopostfix=filename.substring(0,pos);
	//获取oss签名参数
    ...
    {
    	//装配oss签名参数
    	formData.append("name",namenopostfix);
    	formData.append("key", key+namenopostfix);
    	formData.append("policy", policyBase64);
    	formData.append("OSSAccessKeyId", accessid);
    	formData.append("success_action_status", '200');
    	formData.append("Content-Disposition","filename="+filename);
