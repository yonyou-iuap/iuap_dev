 ...
 * @param  {[type]} b) {	function   c(a) {		return function(b) {			return {}.toString.call(b) [description]
...
pageConfig.jdfBaseUri || (pageConfig.jdfBaseUri = "/"), 
...
var login = function() {
	return location.href = "/member/login?ReturnUrl=" + escape(location.href.replace(location.origin, "")), !1
};
var regist = function() {
	return location.href = "/member/toRegister?ReturnUrl=" + escape(location.href.replace(location.origin, "")), !1
};
...
}, /isdebug=(-\d)*-1/.test(location.search) && !
function() {
	function a() {
