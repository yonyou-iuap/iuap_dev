...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarChat = function () {
        ...
        var initChatSlimScroll = function () {
            ...
            // chat user list 
            assetsApp.destroySlimScroll(chatUsers);
            chatUsers.attr("data-height", chatUsersHeight);
            assetsApp.initSlimScroll(chatUsers);
            ...
            // user chat messages 
            assetsApp.destroySlimScroll(chatMessages);
            chatMessages.attr("data-height", chatMessagesHeight);
            assetsApp.initSlimScroll(chatMessages);
        };

        initChatSlimScroll();
        assetsApp.addResizeHandler(initChatSlimScroll); // reinitialize on window resize
    ...
    var handleQuickSidebarAlerts = function () {
        ...
        var initAlertsSlimScroll = function () {
            ...
            // alerts list 
            assetsApp.destroySlimScroll(alertList);
            alertList.attr("data-height", alertListHeight);
            assetsApp.initSlimScroll(alertList);
        };

        initAlertsSlimScroll();
        assetsApp.addResizeHandler(initAlertsSlimScroll); // reinitialize on window resize
    };
    ...
    var handleQuickSidebarSettings = function () {
        ...
        var initSettingsSlimScroll = function () {
            ...
            // alerts list 
            assetsApp.destroySlimScroll(settingsList);
            settingsList.attr("data-height", settingsListHeight);
            assetsApp.initSlimScroll(settingsList);
        };

        initSettingsSlimScroll();
        assetsApp.addResizeHandler(initSettingsSlimScroll); // reinitialize on window resize
    };
