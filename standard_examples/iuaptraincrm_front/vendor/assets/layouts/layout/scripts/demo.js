...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(assetsApp.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function(color) {
            var color_ = (assetsApp.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (assetsApp.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", assetsApp.getGlobalCssPath() + file + ".min.css");
