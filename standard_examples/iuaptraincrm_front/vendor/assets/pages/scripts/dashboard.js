var Dashboard = function() {
    ...
    return {
        ...
        initJQVMAP: function() {
            ...
            assetsApp.addResizeHandler(function() {
        ...
        initCalendar: function() {
            ...
            $('#calendar').fullCalendar({ //re-initialize the calendar
                ...
                events: [{
                    ...
                    backgroundColor: assetsApp.getBrandColor('yellow')
                }, {
                    title: 'Long Event',
                    start: new Date(y, m, d - 5),
                    end: new Date(y, m, d - 2),
                    backgroundColor: assetsApp.getBrandColor('blue')
                }, {
                    title: 'Repeating Event',
                    start: new Date(y, m, d - 3, 16, 0),
                    allDay: false,
                    backgroundColor: assetsApp.getBrandColor('red')
                }, {
                    title: 'Repeating Event',
                    start: new Date(y, m, d + 6, 16, 0),
                    allDay: false,
                    backgroundColor: assetsApp.getBrandColor('green')
                }, {
                    title: 'Meeting',
                    ...
                    backgroundColor: assetsApp.getBrandColor('grey'),
                    allDay: false
                }, {
                    title: 'Birthday',
                    start: new Date(y, m, d + 1, 19, 0),
                    end: new Date(y, m, d + 1, 22, 30),
                    backgroundColor: assetsApp.getBrandColor('purple'),
                    allDay: false
                }, {
        ...
        initEasyPieCharts: function() {
            ...
            $('.easy-pie-chart .number.transactions').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: assetsApp.getBrandColor('yellow')
            });
            ...
            $('.easy-pie-chart .number.visits').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: assetsApp.getBrandColor('green')
            });
            ...
            $('.easy-pie-chart .number.bounce').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: assetsApp.getBrandColor('red')
            });
        ...
        initChat: function() {
            ...
            $('body').on('click', '.message .name', function(e) {
                ...
                assetsApp.scrollTo(input); // scroll to input if needed
            });
        ...
        initDashboardDaterange: function() {
            ...
            $('#dashboard-report-range').daterangepicker({
                ...
                //"endDate": "11/14/2015",
                opens: (assetsApp.isRTL() ? 'right' : 'left'),
