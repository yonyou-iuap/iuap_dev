 ...
 * 直接打印页面，具体打印区域由参数指定
 */
printctr.printDirectCurrentPage= function printDirectCurrentPage() {
...
///////////////////////////////////////////////
printctr.getJsonData = function getJsonData() {
	var obj = {
		no : "20150920001",
...
printctr.getTemplate = function getTemplate() {
	return getTemplate1();
}

printctr.getStyle = function getStyle() {
	return getStyle1();
}
